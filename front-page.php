...
$hero_bg_path = get_template_directory() . '/assets/images/hero/hero-background.gif';
$hero_bg_url = '';
if (file_exists($hero_bg_path)) {
	$hero_bg_url = get_template_directory_uri() . '/assets/images/hero/hero-background.gif';
}
		...
		<div class="bb-section__container">
			...
			<div class="bb-about__composition">
				...
				<div class="bb-about__image-panel bb-scroll-reveal bb-scroll-reveal--left">
					...
					// Single heritage image (new structure: about/about-heritage.jpg)
					$about_img = bunbukan_find_image('DSC01113', array('/assets/images/', '/assets/images/about/', '/bunbukan-eu/public/images/'))
						?: bunbukan_find_image('about-heritage', array('/assets/images/about/', '/assets/images/'));
					if (!$about_img && function_exists('bunbukan_asset_url')) {
						$about_img = bunbukan_asset_url('/assets/images/about/about-heritage.jpg');
					}
					?>
		...
		<div class="bb-section__container">
			...
			<div class="bb-disciplines__stack">
				...
				$karate_logo =
					...
					?: bunbukan_find_image('logo-shitoryu', array('/assets/images/logos/', '/assets/images/'))
					?: (function_exists('bunbukan_asset_url') ? bunbukan_asset_url('/assets/images/logos/logo-shitoryu.jpg') : '');
				...
				$karate_image =
					...
					?: bunbukan_find_image('discipline-karate', array('/assets/images/disciplines/', '/assets/images/'))
					?: (function_exists('bunbukan_asset_url') ? bunbukan_asset_url('/assets/images/disciplines/discipline-karate.jpg') : '');
	...
	<section id="instructors" class="bb-section">
		...
		<div class="bb-section__container">
			...
			<div class="bb-instructors__grid">
				<?php
				$instructor_1_img = bunbukan_find_image('arnaud-enhanced', array('/assets/images/', '/assets/images/instructors/', '/bunbukan-eu/public/images/'));
				if (!$instructor_1_img && function_exists('bunbukan_asset_url')) {
					$instructor_1_img = bunbukan_asset_url('/assets/images/instructors/instructor-arnaud.png');
				}
				$instructor_2_img = bunbukan_find_image('SAI-FINAL', array('/assets/images/', '/assets/images/instructors/', '/bunbukan-eu/public/images/'));
				if (!$instructor_2_img && function_exists('bunbukan_asset_url')) {
					$instructor_2_img = bunbukan_asset_url('/assets/images/instructors/instructor-alain.jpg');
				}
				$instructor_3_img = bunbukan_find_image('quentin-enhanced', array('/assets/images/', '/assets/images/instructors/', '/bunbukan-eu/public/images/'));
				if (!$instructor_3_img && function_exists('bunbukan_asset_url')) {
					$instructor_3_img = bunbukan_asset_url('/assets/images/instructors/instructor-quentin.png');
				}
				$instructors = array(
					array(
